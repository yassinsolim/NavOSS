        ...
        >
          <View style={styles.notice}>
            ...
            <Text style={styles.noticeText}>
              Submissions contain the type, your description, optional place or road label, and
              time. They contain no account, device identifier, or precise coordinate. NavOSS
              retains accepted beta feedback for up to 90 days. Failed submissions stay only on this
              device for retry.
            </Text>
          </View>
