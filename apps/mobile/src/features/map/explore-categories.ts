...
export interface ExploreCategory {
  ...
  label: string;
  query: string;
  searchCategory: NonNullable<SearchQuery['category']>;
}
  ...
  },
  {
    categories: [
      ...
      },
      {
        ...
        searchCategory: 'shopping-centre',
      },
      {
  ...
  },
  {
    categories: [
      ...
      },
      {
        ...
        searchCategory: 'charging-station',
      },
      {
